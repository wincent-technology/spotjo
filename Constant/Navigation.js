    ...
    Home: {
        ...
        navigationOptions: {
            ...
            tabBarIcon: ({
                ...
                const image = focused ?
                    actHome :
                    require('../Img/homeTab.png')
                return (
                    <Image
                source={image}
                style={{width: scale(27),
                height: scale(27)}}
                    />
                )
            }
...
const TabScreenCompany = createBottomTabNavigator({
    ...
    animationEnabled: true,
    initialRouteName: 'Home',
    order: ['Home', 'UserProfile', 'ComEdit', 'ScreenMap', 'Admin', 'CompanyServices', 'CompanyUser'],
    tabBarPosition: 'bottom',
    lazy: false,
    tabBarOptions: {
        keyboardHidesTabBar: true,
