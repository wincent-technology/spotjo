...
class SettingGuest extends Component {
    state={
...
<SettingsList borderColor='gray'>
                                  ...
                                  <SettingsList.Item
                                    ...
                                    arrowStyle={{height:20,width:20,tintColor:'gray'}}
                                    title={global.language == 'english' ? 'Login' : 'german'}
                                    onPress={()=> this.props.navigation.navigate('LoginFirst')}
                                      />
                                  </SettingsList>
                                  </View>
