    ...
    render() {
        ...
        <View style={[{
            ...
            style={{
                ...
                top: scale(20)
            }}><CustomInput value={this.state.name} placeholder = {'E.g (Java Developer)'} textChange = {
            (text) => {
                this.setState({
            ...
            <View style={{
                ...
                {suggesion && suggesion.map((elements, index) => <TouchableWithoutFeedback onPress = {() => this.suggestionTag(elements, index)}>
            ...
            <TouchableOpacity style={styles.Size} onPress={this.back} hitSlop={{top: 40, bottom: 40, left: 50, right: 50}}>
            <View  style={styles.Size}><Text style={[{
                fontSize: scale(20),
