...
class ScreenMap extends PureComponent {
  ...
  change = async (value) => {
    ...
    console.log('radius', radius, value, (radius * radius) / 111.045);
            ...
            <MapView.Animated
              ...
              onRegionChangeComplete={async (region) => {
                ...
                this.setState(
                  ...
                  () => {
                    global.let = this.state.region.latitude;
                    global.long = this.state.region.longitude;
                  },
                );
              }}
