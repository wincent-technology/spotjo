...
const ASPECT_RATIO = wp(85) / wp(65);
...
console.log('hasto>>>',global.reset ,global.region,global.Favorite_Location)

  global.reset == false ? this.setState(global.region) : this.setState(
    { name: '',
    dataCheck: [],
    PlaceText:'',
    show: false,
...
console.log('hasto>>>',global.Job_Location,global.Favorite_Location)
         ...
         p =global.Job_Location && global.Job_Location.map(item => {
            let temp={}
            // p.push(item.place);
            ...
            console.log('p',global.Job_Location)
