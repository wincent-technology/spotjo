...
class UserCreation extends PureComponent {
    ...
    render() {
        ...
        return (
            ...
            <View style={{
                marginTop: hp(2)
            }}><CustomInput placeholder = {'First Name'} textChange = {(text) => this.setState({
                firstName: text
            })}
            inputContainerStyle={{
            ...
            <View style={{
                marginTop: scale(10)
            }}><CustomInput placeholder = {'Last Name'} textChange = {(text) => this.setState({
                lastName: text
            })}
            inputContainerStyle={{
                backgroundColor: themeColor,
