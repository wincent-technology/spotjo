    ...
    render() {
        ...
        <StatusBar hidden={true}/>
            ...
            <TouchableWithoutFeedback onPress={() => this.Shortlisted()}><View style={[
                {borderWidth:this.state.short ? scale(2):0},styles.postedJoblist]}><ImageBackground source={canvas} style={{
               width: '100%',
                height: '100%',
                alignItems: "center",
            ...
            <TouchableWithoutFeedback onPress={() => this.InterView()}><View style={[
                {borderWidth:this.state.int ? scale(2):0,marginHorizontal:scale(5)},styles.postedJoblist]}><ImageBackground source={canvas} style={{
                width: '100%',
                height: '100%',
                alignItems: "center",
                justifyContent: "center"
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.InterView.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>InterView</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.Selected()}><View style={[
                {borderWidth:this.state.sel ? scale(2):0},styles.postedJoblist]}><ImageBackground source={canvas} style={{
                width: '100%',
                height: '100%',
                alignItems: "center",
                justifyContent: "center"
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.Selected.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Selected</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            </View>
   {data != '' ? (<FlatList
            style={{
                marginTop: 4,
