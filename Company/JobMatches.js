...
class JobMatches extends PureComponent {
    ...
    render() {
        ...
        <StatusBar hidden={true}/>
            ...
            <TouchableWithoutFeedback onPress={() => this.Shortlisted()}><View style={[{
                borderWidth:this.state.short ? scale(2) : 0,
            },styles.MatchersStyleTab]}><ImageBackground source={canvas} style={{
                height: '100%',
                width: '100%',
                // position: "absolute",
                alignItems: "center",
                ...
                color: themeWhite
            }}>{this.state.Shortlisted.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Shortlisted</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.Matched()}><View style={[{
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.Matched.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Matched</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.Rejected()}><View style={[{
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.Rejected.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Rejected</Text></View></ImageBackground></View></TouchableWithoutFeedback>
           <TouchableWithoutFeedback onPress={() => this.Applied()}>
            <View style={[{
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.Applied.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Applied</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.Interested()}><View style={[{
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.Interested.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>Interested</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.NotInterested()}><View style={[{
                ...
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }}>{this.state.NotInterested.length}</Text><View><Text style={{
                fontSize: scale(16),
                fontFamily: 'Roboto-Regular',
                color: themeWhite
            }} numberOfLines={1}>Not Interested</Text></View></ImageBackground></View></TouchableWithoutFeedback>
            </ScrollView>
            </View>
   {data != '' ? (<FlatList
            style={{
            ...
            renderItem={({item, index}) => <ItemMVJobbM
                item={item}
                index={index}
                push={this.push}
                Video={this.Video}
