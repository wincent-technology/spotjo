    ...
    render() {
        ...
        return (
           ...
           emptyStar={blanks}
            ...
            <TouchableNativeFeedback onPress={this.Dashboard}  background={TouchableNativeFeedback.Ripple(themeColor)}>
                <View style={styles.NativeViewButton}>
            <View style={styles.NativeSecondView}>
                    <Image source={Dashboard} resizeMethod={'resize'} style={styles.imageStyle} resizeMode={'contain'} />
            </View>
            ...
            <TouchableNativeFeedback onPress={this.Personal}  background={TouchableNativeFeedback.Ripple('#feba4b')}>
                <View style={styles.NativeViewButton}>
            <View style={styles.NativeSecondView}>
                    <Image source={education} resizeMethod={'resize'} style={styles.imageStyle} resizeMode={'contain'} />
            </View>
            <View style={styles.NativeThirdView}>
                <Text style={styles.NativeFontSty} numberOfLines={1}>
                    Company Information
            ...
            <TouchableNativeFeedback onPress={this.CompanyService}  background={TouchableNativeFeedback.Ripple('#8bbdb2')}>
                <View style={styles.NativeViewButton}>
            <View style={styles.NativeSecondView}>
                    <Image source={company} resizeMethod={'resize'} style={styles.imageStyle} resizeMode={'contain'} />
            </View>
            <View style={styles.NativeThirdView}>
                <Text style={styles.NativeFontSty} numberOfLines={1}>
                    Company Services
            ...
            {global.role != 'Staff' && <TouchableNativeFeedback onPress={this.User}  background={TouchableNativeFeedback.Ripple('#a26e85')}>
                <View style={styles.NativeViewButton}>
            <View style={styles.NativeSecondView}>
                    <Image source={jobType} resizeMethod={'resize'} style={styles.imageStyle} resizeMode={'contain'} />
            </View>
            <View style={styles.NativeThirdView}>
                <Text style={styles.NativeFontSty} numberOfLines={1}>
                    User Management
