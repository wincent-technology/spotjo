            ...
            <ScrollView
                    ...
                    return (
                      <View style={styles.itemsHiddenView}>
                        ...
                        <View style={styles.itemsHiddenTView}>
                          <Text style={styles.addSkillFont} numberOfLines={1}>
                            {item.name}
                          </Text>
                        </View>
              ...
              <View
                ...
                <CustomInput
                  ...
                  onSubmitEditing={(event) =>
                    this.Education(event.nativeEvent.text)
                  }
                />
                <ScrollView
                  style={{
                      ...
                      <View style={styles.itemsHiddenView}>
                        ...
                        <View style={styles.itemsHiddenViewRate}>
                          <StarRating
                            ...
                            rating={item.rating}
                            selectedStar={(rating) =>
                              this.handleEducation(rating, index)
                            }
                            fullStarColor={'orange'}
                          />
                        </View>
              ...
              <View
                ...
                <CustomInput
                  ...
                  onSubmitEditing={(event) =>
                    this.Language(event.nativeEvent.text)
                  }
                />
                <ScrollView
                  style={{
                      ...
                      <View style={styles.itemsHiddenView}>
                        ...
                        <View style={styles.itemsHiddenViewRate}>
                          <StarRating
                            ...
                            rating={item.rating}
                            selectedStar={(rating) =>
                              this.handleLanguage(rating, index)
                            }
                            fullStarColor={'orange'}
                          />
                        </View>
